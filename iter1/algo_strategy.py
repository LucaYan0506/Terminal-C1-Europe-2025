...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def starter_strategy(self, game_state):
        ...
        if game_state.get_resource(MP) > 9.0:
            ...
            if enemyBuildingCount > 10:
                return
            
            if enemyBuildingCount > 4:                       # for every 4 enemy building generate 1 demolisher
                game_state.attempt_spawn(DEMOLISHER, [3,10], enemyBuildingCount // 4)
    ...
    def build_tower(self, game_state):
        ...
        # # Place walls in the first line to block mobile units
        # wall_locations = []
        # for i in range(28):
        #     # leave one open ports
        #     if i == 3:
        #         continue
        #     wall_locations.append([i,i])
